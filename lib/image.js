 ...
 *
 * Exported because lib/ocr.js needs the same decode: the orientation tag is the
 * single most common reason a phone photo arrives sideways, and OCR on a
 * sideways card reads nothing at all. Two decoders would be two chances to get
 * that wrong.
 */
